...
{
    private const array FORMATS = ['png', 'jpg', 'webp'];
    ...
    public function __construct(protected readonly ImagineInterface $imagine)
    {
        ...
        $resolver->setAllowedValues('format', function (string|null $value) use ($imagine) {
            if (!\str_contains(\get_class($imagine), 'Imagick')) {
                return false;
            }
            ...
            return \in_array($value, self::FORMATS);
        });
