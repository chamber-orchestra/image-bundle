...
class FileSystemLocator implements LocatorInterface
{
    ...
    public function locate(string $path): string
    {
        ...
        if ($path = $this->sanitizeAbsolutePath($path)) {
            return $path;
        }
    ...
    private function locateUsingRootPathsSearch(string $path): string|null
    {
    ...
    private function locateUsingRootPlaceholder(string $path): string|null
    {
