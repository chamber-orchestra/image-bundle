...
|-----------|------|---------|-------------|
| `key` | `string` | `'default'` | Key in the serialized output |
| `filter` | `string` | `'fill'` | Processor type: `fill`, `fit`, or `optimize` |
| `width` | `int` | `0` | Logical width in CSS pixels |
| `height` | `int` | `0` | Logical height in CSS pixels (0 = auto) |
| `densities` | `int[]` | `[1, 2, 3, 4]` | Pixel densities to generate |
| `preset` | `string` | `'default'` | Named filter from `chamber_orchestra_image.filters.*` |
